...
class FastDiffusionGNN2(torch.nn.Module):
    """
    Fast Diffusion Graph Neural Network (FDGNN2) diseñada para el filtrado rápido (Fase 2).
    ...
    def __init__(
        ...
        """
        super(FastDiffusionGNN2, self).__init__()
