...
def analyze_convergence_and_diffusion(
    ...
    """
    traj_file   = f'{md_path}/GdCeO2.traj'
    ...
    for specie in unique_species:
        ...
        try:
            ...
            diffusion_results[specie] = {
                'diffusivity_cm2s':      analyzer.diffusivity,
                'diffusivity_cm2s_std':  analyzer.diffusivity_std_dev,
                'conductivity_mScm':     analyzer.conductivity,
                'conductivity_mScm_std': analyzer.conductivity_std_dev
            }
